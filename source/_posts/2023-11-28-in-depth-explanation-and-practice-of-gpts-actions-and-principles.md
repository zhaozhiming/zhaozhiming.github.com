...
下面是具体的接口信息，我们先看一下获取创建宠物的接口信息，为了让大家更好的理解，笔者对接口信息进行了一些小调整：
...
以上就是 GPT Action 的配置方法，我们通过了搭建本地服务来验证了 Action 的各种认证机制，在实践的过程中也了解了 Action 的工作原理，借助于 Action 外接 API 服务的能力，我们可以将 GPT 应用到更多的场景中，可以定制更多强大的功能，希望本文可以帮助大家更好的使用 GPT Action，打造出更加强大的 GPT。如果大家对文章有什么问题，可以在评论区留言一起讨论。
